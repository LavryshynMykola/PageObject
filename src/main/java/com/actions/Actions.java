...
public class Actions   {
    ...
    public static By clickRunLinkLocator = By.xpath("//div[@class='header__botline-inside']//a[text()='Run Project']");
    public static By headingLocator = By.xpath("//div[@class='intro box-md']/h1");
